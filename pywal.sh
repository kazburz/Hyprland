...
#### Change "~/.config/hypr/wals/ " to the folder/directory you keep you wallpaper images.

wall=$(find ~/.config/hypr/wals/  -type f -name "*.jpg" -o -name "*.png" -o -name "*.gif" | shuf -n 1)
